...
export const colorPresets: ColorPreset[] = [
  // DEFAULT
  {
    ...
    darker: palette.light.primary.darker,
...
export type PresetsKey = "default" | "purple" | "cyan" | "blue" | "orange" | "red";

export default function getColorPresets(presetsKey: PresetsKey): ColorPreset {
  return {
    purple: purplePreset,
    cyan: cyanPreset,
    blue: bluePreset,
